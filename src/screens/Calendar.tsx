...
export default function Calendar() {
  ...
  /* ── Grid dot helpers (exact-day markers only) ───────────────── */
  ...
  return (
    <div className="pb-4">
      ...
      {/* ── Calendar grid (dots only — no day selection) ─────── */}
            ...
            return (
              <div
                ...
                className={`flex flex-col items-center py-2 rounded-xl ${
                  todayCell ? 'bg-indigo-50 dark:bg-indigo-900/30' : ''
                }`}
              >
      ...
      {/* ── Upcoming list (always from today, no tap needed) ──── */}
      <div className="px-4 mt-4 space-y-4">

        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-bold text-gray-900 dark:text-white text-sm">Coming up</h3>
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Everything from today onward</p>
          </div>
          {totalItems > 0 && (
